    ...
    <>
      ...
      <div className="bg-white">
        ...
        <FadeInSection className="relative text-center bg-black">
          ...
          />
          <img
            className="w-14 absolute md:block hidden top-[20%] left-48 animate-float"
            style={{ animationDelay: "0.6s" }}
            src={graduated}
            alt=""
          />
          <img
            className="w-20 absolute md:block hidden top-16 right-[15%] animate-float"
          ...
          <div className="relative py-10 md:py-20 ">
            <h1 className="mb-4 text-2xl font-bold text-white md:text-6xl animate-fadeInUp">
              Welcome to{" "}
              <span className="text-3xl border-b-8 md:text-7xl">MentorHub</span>
            </h1>
            <p
              className="my-10 text-base text-gray-200 md:my-16 md:text-2xl animate-fadeInUp"
            ...
            >
              <NavLink to="/mentors">
                <button className="px-8 py-3 text-white transition-all duration-300 bg-purple-600 rounded-lg hover:bg-purple-800 hover:scale-105 active:scale-95">
                  Find Your Mentor
                </button>
              </NavLink>
            </div>
            <img
              className="absolute hidden md:block w-14 left-1/3 animate-float"
          ...
          <div className="relative">
            <img
              className="absolute hidden md:block w-14 top-56 left-28 animate-float"
              style={{ animationDelay: "0.8s" }}
              src={coding}
              alt=""
            />
            <img
              className="absolute hidden md:block w-14 top-3 right-28 animate-float"
            ...
            <video
              ...
              loop
              muted
              className="inset-0 object-cover w-full p-2 mx-auto rounded md:p-0 md:w-2/3 h-2/3 animate-fadeIn"
            >
              <source src={heroVideo} type="video/mp4" />
            </video>

            <img
              className="absolute hidden md:block w-14 bottom-96 right-28 animate-float"
